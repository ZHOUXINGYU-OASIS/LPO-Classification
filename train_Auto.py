...
from model_BiLSTM_cpu import StructData
from model_BiLSTM_cpu import Model_LeakyReLU
from model_BiLSTM_cpu import Model_ReLU
from model_BiLSTM_cpu import Model_Tanh
    ...
    for k2 in range(4):
        ...
        for k3 in range(3):
            ...
            if k3 == 0:
                ...
                model = Model_LeakyReLU(13, hidden_size, num_layers, 5)
                fun_name = 'LeakyReLU'

            if k3 == 1:
                # input_size hidden_size num_layers output_size
                model = Model_ReLU(13, hidden_size, num_layers, 5)
                fun_name = 'ReLU'

            if k3 == 2:
                # input_size hidden_size num_layers output_size
                model = Model_Tanh(13, hidden_size, num_layers, 5)
                fun_name = 'Tanh'
            ...
            path = './TrainingResults/' + fun_name + '_%d_%d' % (num_layers, hidden_size)
